...
public class IncorrectKeyException extends ResponseStatusException {
    ...
    public IncorrectKeyException(String id) {
        super(STATUS, buildReason(id));
    }

    public IncorrectKeyException(String id, Throwable cause) {
        super(STATUS, buildReason(id), cause);
    }

    private static String buildReason(String id) {
        return String.format("The incorrect key was provided for event [%s]. ", id);
    }
}
